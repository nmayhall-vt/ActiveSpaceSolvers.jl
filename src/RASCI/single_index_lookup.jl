...
function generate_single_index_lookup(bra::RASCIAnsatz, ket::RASCIAnsatz, spin::String)
    if spin == "alpha"
        a_ket_graph = RASCI_OlsenGraph(ket.no, ket.na, ket.ras_spaces, ket.ras1_min, ket.ras3_max)
        a_bra_graph = RASCI_OlsenGraph(bra.no, bra.na, bra.ras_spaces, bra.ras1_min, bra.ras3_max)
        ...
        b_ket_graph = RASCI_OlsenGraph(ket.no, ket.nb, ket.ras_spaces, ket.ras1_min, ket.ras3_max)
        b_bra_graph = RASCI_OlsenGraph(bra.no, bra.nb, bra.ras_spaces, bra.ras1_min, bra.ras3_max)
